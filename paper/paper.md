...
![Map layers for terrain assessment. Left: Soil map with sand (yellow), gravel (green), and unknown (light blue). Right: Corresponding traversability map, where sand is treated as obstacle (red).](figures/soilmap.png)
